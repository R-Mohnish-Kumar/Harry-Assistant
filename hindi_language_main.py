...
def run_in_hindi():
    ...
    def wishMe():
        ...
        if hour >= 0 and hour < 12:
            speak("शुभ प्रभात" + master)

        elif hour >= 12 and hour < 15:
            speak("सुसंध्या" + master)
    ...
    def run_harry():
        ...
        if ('कौन हो तुम' in command):
            speak('मैं हैरी हूं। मोहनीशकुमार हरिनी और विजय द्वारा विकसित एक आभासी सहायक')
        ...
        elif 'गूगल' in command:
            website=command.replace('गूगल','')
            speak(website+'चालू कर रहा हूं')
            url_google='https://www.google.com'
            url=url_google.replace(' ','')
            webbrowser.open(url)
        elif 'भाषा बदलिए' in command:
            main.language()
